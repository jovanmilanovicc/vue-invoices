                ...
                <div class="work-items">
                    ...
                    <table class="item-list">
                        ...
                        <tr class="table-items flex" v-for="(item, index) in invoiceItemList" :key="index">
                            ...
                            <img @click="deleteInvoiceItem(item.id)" class="cursor-pointer"
...
export default {
    ...
    watch: {
        paymentTerms() {
            ...
            this.paymentDueDateUnix = futureDay.setDate(futureDay.getDate() + parseInt(this.paymentTerms));
            this.paymentDueDate = new Date(this.paymentDueDateUnix).toDateString('en-us', this.dateOptions);
        }
    },
    created() {
        if (!this.editInvoice) {
