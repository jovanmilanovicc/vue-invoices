<template>
    <div v-if="currentInvoice" class="invoice-view container">
        <router-link class="nav-link flex" :to="{ name: 'home' }">
            <img src="@/assets/icon-arrow-left.svg" alt="Image" /> Go Back
        </router-link>
        <div class="flex header">
            ...
            <div class="flex right">
                ...
                <button @click="updateStatusToPending(currentInvoice.docId)"
                    v-if="currentInvoice.invoiceDraft | currentInvoice.invoicePaid" class="orange">Mark as
                    Pending</button>
            </div>
        </div>
...
export default {
    ...
    methods: {
        ...
        toggleEditInvoice() {
            if(this.currentInvoice.invoicePaid){
                alert("Cant changed paid invoice");
                return;
            }
